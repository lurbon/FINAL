    ...
    <div class="page-wrapper">
        ...
        <div class="user-bar">
            ...
            <div class="center-section">
                <a href="../assets/images/photo.jpg" title="Voir le monstre">
                    <img src="../assets/images/cam.jpg" width="60" height="60" alt="">
                </a>
            </div>
            ...
            <div class="top-section">
                ...
                <div class="container" id="mainBlock">
                    <div class="header-section">
                        <img src="../assets/images/Logo-Entraide-Plus-Iroise.jpg" alt="Logo" class="logo">
            ...
            // INTERFACE BÉNÉVOLE
                ...
                document.getElementById('mainBlockGrid').innerHTML = `
                    <div style="display: flex; justify-content: center; align-items: center;">
                        <img src="../assets/images/Logo-Entraide-Plus-Iroise.jpg" alt="Logo" style="width: 180px; height: auto; object-fit: contain;">
                    </div>
